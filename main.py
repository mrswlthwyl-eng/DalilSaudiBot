...
def create_stipend_response():
    ...
    hijri_month_name = HIJRI_MONTHS.get(
        hijri_month,
        ""
    )
    ...
    response = (
        ...
        "💰 <b>المكافأة الشهرية</b>\n\n"

        "• مكافأة التخصصات العلمية والصحية والهندسية: "
        f"<b>{STIPEND_SCIENTIFIC} ريال</b>.\n\n"

        "• مكافأة التخصصات الأدبية والإدارية: "
        f"<b>{STIPEND_ADMINISTRATIVE} ريال</b>.\n\n"
...
def is_stipend_question(
    ...
    stipend_words = [
        ...
        "موعد المكافاه الجامعيه",
        "موعد المكافاة الجامعية",
        ...
        "ايداع المكافاه الجامعيه",
        "ايداع المكافاة الجامعية",
...
async def reply_message(
    ...
    # نظام المكافأة
    # ========================================================
    # هذا الجزء أضيف فقط للمكافأة.
    # إذا كان السؤال عن المكافأة، يتم الرد
    # بالحساب التلقائي ولا يتم البحث في القناة.
    # ========================================================
    ...
    if is_stipend_question(
        ...
        print(
            "سيتم حساب موعد المكافأة تلقائيًا."
        )
...
async def on_startup(
    ...
    print(
        "✅ نظام المكافأة يعمل بالحساب التلقائي."
    )
